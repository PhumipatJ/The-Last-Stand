...
public class WomenZombie extends Zombie {
    private int frameCounter = 0;

    public WomenZombie(float x, float y, String word) {
        super(x, y, 3, word, 15);
    }
    ...
    public void loadImages() {
        ...
        URL image1Url = getClass().getResource("/picture/woman_zombie/woman_zombie_1.png");
        URL image2Url = getClass().getResource("/picture/woman_zombie/woman_zombie_2.png");
        URL image3Url = getClass().getResource("/picture/woman_zombie/woman_zombie_3.png");
    ...
    public void draw(Graphics g){
        ...
        frameCounter++;
        if (frameCounter >= 2) { // smaller = faster
